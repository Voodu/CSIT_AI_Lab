...
class Tank:
    ...
    def forward(self, velocity=None):
        ...
        velocity : float | None
            ...
            Float - takes values from <-10,10> and sets them as velocity for both wheels in forward direction
        '''
        self.go()
        if velocity!=None:
    ...
    def backward(self, velocity=None):
        ...
        velocity : float | None
            ...
            Float - takes values from <-10,10> and sets them as velocity for both wheels in backward direction.
        '''
        self.go()
        if velocity!=None:
            self.leftvelocity=-velocity
    ...
    def turn_left(self, velocity=None):
        ...
        velocity : float | None
            ...
            Float - takes values from <-10,10> and sets it as velocity for right wheel in forward direction and oposite value of velocity for left wheel in backward direction
        '''
        self.go()
        if velocity!=None:
            self.leftvelocity =-velocity
    ...
    def turn_right(self, velocity=None):
        ...
        velocity : float | None
            ...
            Float - takes values from <-10,10> and sets it as velocity for left wheel in forward direction and oposite value of velocity for right wheel in backward direction
        '''
        self.go()
        if velocity!=None:
            self.leftvelocity = velocity
