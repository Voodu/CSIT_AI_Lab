### Exercise 2.1 - Genetic Algorithm
...
### Exercise 2.2 - PSO
Implement the Particle Swarm Optimization algorithm to find the minimum of the following function:
f(x,y) = (1.5 – x -xy)^2 + (2.25 – x + xy^2)^2 + (2.625 – x + xy^3)^2 for x, y in range <-4.5, 4.5>
Test your algorithm using different parameters and analyze the results.
